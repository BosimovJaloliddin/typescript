...
//   status: "student",
// };
// function getUser<T, K extends keyof T>(user: T, key: K) {
//   return user[key];
// }
// getUser<User, keyof User>(user, "id");
// interface User<Type> {
//   (arg: Type): Type;
// }
// function getUser<Type>(user: Type): Type {
//   return user;
// }
// const GenericUser: User<number> = getUser;
// const Generic: User<string> = getUser;
// GenericUser(12);
// Generic("sq");
// type Config<T> = {
...
//   body: T;
// };
// function getData<T>(data: T): Config<T> {
//   let config: Config<T> = {
//     method: "POST",
//     headers: {
...
//   return config;
// }
// getData<{ id: number; name: string }>({ id: 1, name: "Jalol" });
// console.log((1.5 - 1) * 2);
// for (let i = 0; i < 10; ++i) {
//   console.log(i);
// }
